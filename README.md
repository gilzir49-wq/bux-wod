...
### 🌐 לינק חי (לשיתוף עם המתאמנים): **https://gilzir49-wq.github.io/bux-wod/**
> נפתח בכל טלפון, ניתן להתקנה למסך הבית כאפליקציה, ועובד גם אופליין. כל `git push` לענף `main` מעדכן אוטומטית את הלינק החי.
