...
export default function Page() {
  ...
  function toggleEquipment(e: Equipment) {
    // Pure multi-select: every chip toggles independently so members can pick
    // as many as they have around them. If everything is cleared we fall back
    // to bodyweight so a workout can always be built.
    setEquipment((prev) => {
